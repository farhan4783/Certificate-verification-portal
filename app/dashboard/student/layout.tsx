        ...
        <div className="px-6 py-5 border-b border-slate-800">
          <div className="flex items-center gap-2">
            <div className="h-7 w-7 rounded-lg bg-emerald-500/20 border border-emerald-500/30 flex items-center justify-center">
              <span className="text-emerald-400 text-xs font-bold">KTC</span>
            </div>
            <span className="font-bold text-sm tracking-wider bg-gradient-to-r from-emerald-200 to-emerald-400 bg-clip-text text-transparent">
              KODE TO CAREER
            </span>
          </div>
        </div>
        <div className="px-6 py-4 border-b border-slate-800">
          <p className="text-[10px] font-mono text-emerald-500 uppercase tracking-widest">Student Portal</p>
