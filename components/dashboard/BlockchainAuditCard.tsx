...
import { Link2, ShieldCheck, HelpCircle, X, Cpu } from "lucide-react";
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <button
            ...
            type="button"
            className="mt-3.5 inline-flex items-center gap-1.5 text-xs text-cyan-400 hover:text-cyan-300 font-semibold border-b border-dashed border-cyan-500/30 hover:border-cyan-400/60 pb-0.5 transition-colors"
          >
            <Link2 className="h-3.5 w-3.5" />
            Audit Ledger Payload Verification
          </button>
        </div>
      </div>
            ...
            <div className="p-6 overflow-y-auto space-y-5 font-mono text-[11px]">
              ...
              <div className="space-y-2 bg-slate-950/50 p-4 rounded-xl border border-slate-850">
                ...
                <div className="flex flex-col py-1.5">
                  <span className="text-slate-500 uppercase mb-1">Decentralized PDF SHA-255 Hash</span>
